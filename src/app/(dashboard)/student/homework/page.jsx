  ...
  return (
    ...
    <div className='w-[100%] pr-[60px]'>
      ...
      <div className='p-[15px] mt-[15px]'>
         ...
         <div>
            <p className='h-[60px] pl-[15px] border-[0.5px] border-[#00000066] font-poppins text-[20px] font-[600] text-dark leading-[30px] flex items-center'>Lokon Islam</p>
            <p className='h-[60px] pl-[15px] border-[0.5px] border-[#00000066] font-poppins text-[20px] font-[600] text-dark leading-[30px] flex items-center my-[10px]'>10 Points</p>
            <p className='h-[60px] pl-[15px] border-[0.5px] border-[#00000066] font-poppins text-[20px] font-[600] text-dark leading-[30px] flex items-center'>Due Date: 10</p>
         </div>
      </div>

      <div className='bg-[#CCCCCC] pt-[35px] px-[40px] pb-[80px]'>
        <h1 className='font-montagu text-[24px] font-[400] text-dark leading-[30.77px]'>Instruction</h1>
